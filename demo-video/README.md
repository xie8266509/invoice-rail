...
This Remotion project renders a 51-second reviewer-facing product film from two real Arc Testnet payment runs: one USDC settlement and one EURC settlement. The film deliberately uses no synthetic narration: the story is carried by the product, proof, typography, music, and restrained UI sound.
...
- `public/v2/invoice-paid-eurc.png`: real EURC paid receipt from the second verified run
...
EURC transaction: `0xc877dd1382a0721c0805497ae475a64c204da107e5b3e80e725cb579d6e6a493`
